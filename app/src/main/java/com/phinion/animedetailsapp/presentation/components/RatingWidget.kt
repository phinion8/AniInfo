...
import com.phinion.animedetailsapp.ui.theme.EXTRA_SMALL_PADDING
import com.phinion.animedetailsapp.ui.theme.StarColor
...
fun RatingWidget(
    ...
    //converting the string path into the path object
...
@Composable
fun FilledStar(
    starPath: androidx.compose.ui.graphics.Path,
    starPathBounds: Rect,
    scaleFactor: Float
) {
    Canvas(modifier = Modifier.size(24.dp)) {
        ...
        scale(scale = scaleFactor) {
            ...
            //this translate function will move over star to the centre
        ...
        scale(scale = scaleFactor) {
            ...
            translate(left = left, top = top) {
                ...
                clipPath(path = starPath) {
                    //intersecting the rectangle on the star path
                    drawRect(
                        color = StarColor,
                        size = Size(
    ...
    LaunchedEffect(key1 = rating) {
        ...
        if (firstNumber in 0..5 && lastNumber in 0..9) {
            ...
            if (firstNumber == 5 && lastNumber > 0) {
                ...
                Log.d("RatingWidget", "Invalid rating widget")
            }
